...
start_test_1P="kubectl exec -it ${iperf3_client} -n iperf3 -c iperf3 -- bash -c \"iperf3 -c ${iperf3_svc_ip} -t 60\""
start_test_2P="kubectl exec -it ${iperf3_client} -n iperf3 -c iperf3 -- bash -c \"iperf3 -c ${iperf3_svc_ip} -t 60 -P 2\""
